...
<div class="crm-block crm-form-block crm-recurcontrib-form-block">
	...
	<div id="help">
		{ts}Use this form to change the amount or number of installments for this recurring contribution. Changes will be automatically applied to the payment processor. You can not change the contribution frequency.{/ts}
  </div>
	{/if}
