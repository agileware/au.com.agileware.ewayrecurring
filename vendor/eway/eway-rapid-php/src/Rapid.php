...
abstract class Rapid {
  ...
  /**
   * Static method to create a new Rapid Client object configured to
   * communicate with a specific instance of the Rapid API.
   *
   * @param string $apiKey eWAY Rapid API key
   * @param string $apiPassword eWAY Rapid API password
   * @param string $endpoint eWAY Rapid API endpoint - one of 'Sandbox' or
   *   'Production'
  ...
  /**
   * This static method provides a message suitable for display to a user
   * corresponding to a given Rapid Code & language.
   *
