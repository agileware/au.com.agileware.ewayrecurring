 ...
 * @property string $Number      Credit card number (16-21 digits plaintext, Up
 *   to 512 chars for eCrypted values)
 ...
 * @property string $CVN         Required for transactions of type Purchase.
 *   Optional for other transaction types.
 *                                (3 or 4 digit number plaintext, up to 512
 *   chars for eCrypted values)
 */
