 ...
 * Class Refund.
 *
 * @property int $TransactionID      The ID of either the transaction to
 *   refund, or the authorisation to cancel.
 * @property int $TotalAmount        The total amount to refund the card holder
 *   in this transaction in cents. e.g. 1000 = $10.00
