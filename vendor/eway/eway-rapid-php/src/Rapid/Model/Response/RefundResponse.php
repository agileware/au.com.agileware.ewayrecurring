...
/**
 * This Response is returned by the Refund Method. It wraps the
 * TransactionStatus and the Echoed back Refund Type with the standard error
 * fields required by an API return type.
 *
