 ...
 *
 * @property string $City            The customer's shipping city / town /
 *   suburb.
 * @property string $Country         The customer's shipping country. This
 *   should be the two letter ISO 3166-1 alpha-2 code. This field must be lower
 ...
 * @property string $FirstName       The first name of the person the order is
 *   shipped to.
 * @property string $LastName        The last name of the person the order is
 *   shipped to.
 * @property string $Phone           The phone number of the person the order
 *   is shipped to.
 ...
 * @property string $Street1         The street address the order is shipped
 *   to.
 * @property string $Street2         The street address of the shipping
 *   location.
 */
