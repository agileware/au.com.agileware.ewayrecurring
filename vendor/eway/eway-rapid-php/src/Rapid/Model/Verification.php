 ...
 * @property string $Address     Result of Address Verification by card
 *   processor
 * @property string $Email       Result of email verification by card processor
 * @property string $Mobile      Result of Mobile verification by card
 *   processor
 * @property string $Phone       Result of phone verification by card processor
 * @property string $BeagleEmail Result of email verification from responsive
 *   shared page
 * @property string $BeaglePhone Result of phone number verification from
